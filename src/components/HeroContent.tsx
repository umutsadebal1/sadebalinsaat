  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Sadebal Yapı · İnşaat &amp; Gayrimenkul
        </motion.p>
        <motion.h1
          variants={item}
        ...
        >
          Konut ve ticari projelerde güvenilir mühendislik, zamansız mimari
          anlayışıyla geleceğin yapılarını bugünden inşa ediyoruz.
        </motion.p>
